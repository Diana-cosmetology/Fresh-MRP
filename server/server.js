...
app.get('/erp/manufacturing/:id:format?', app.wrap(erpController.getManufacturingItem))
app.post('/erp/manufacturing/:id:format?', app.wrap(erpController.saveManufacturingItem))
app.post('/erp/manufacturing', app.wrap(erpController.newManufacturingItem))
app.delete('/erp/manufacturing/:id:format?', app.wrap(erpController.removeManufacturingItem))
